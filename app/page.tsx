...
export default function Page() {
  ...
  const donate = () => document.getElementById('contribute')?.scrollIntoView({ behavior: 'smooth' })
  return <main id="top"><div className="site-header-wrapper"><Header onDonate={donate} /></div>
    ...
    <section className="foundation section-wrap" id="foundation"><div className="section-index">01 / 02</div><div className="foundation-grid"><div className="foundation-left"><div className="foundation-photo"><img src={images.mission} alt="Children and a community member together outdoors" /></div><blockquote className="foundation-quote">World Hunger Team seeks to improve the health and well-being of people in poverty by enabling access to organic and sustainable nutrition and safe, clean drinking water.</blockquote></div><div className="foundation-text"><div className="section-heading" style={{ margin: '0 0 2.5rem' }}><p className="eyebrow">OUR FOUNDATION</p><h2 className="section-title">Restoring across<br /><em>Nutrition, Health<br />and Dignity</em><br />America and the World</h2></div><p>WHT is not a food pantry or a farm, although we work with many people who operate them. We create affordable and simple SYSTEMS in 3 categories:</p><div className="system-list"><a href="#foundation"><span>01</span><div><strong>GROW ORGANIC FOOD</strong><p className="system-note">Simple, affordable systems for growing organic food.</p></div><i>↗</i></a><a href="#foundation"><span>02</span><div><strong>CAPTURE &amp; STORE RAINWATER</strong><p className="system-note">Systems that capture and store rainwater where it falls.</p></div><i>↗</i></a><a href="#foundation"><span>03</span><div><strong>PROCESS RAINWATER</strong><p className="system-note">Processing rainwater for agriculture and personal use (WASH).</p></div><i>↗</i></a></div></div></div></section>

    <section className="contribute section-wrap" id="contribute"><div className="section-index" style={{ left: 'auto', right: '1.5rem', writingMode: 'horizontal-tb' }}>02 / 02</div><div className="section-heading" style={{ margin: '0 0 3rem' }}><p className="eyebrow">WAYS TO CONTRIBUTE</p><h2 className="section-title">Be part of<br /><em>the change.</em></h2></div><div className="contribute-actions-grid"><a href="#contribute" className="contribute-card"><div className="card-header"><span className="eyebrow">01</span><i>↗</i></div><h3>DONATE</h3><p>Fund the systems that grow food and clean water.</p></a><a href="#contribute" className="contribute-card"><div className="card-header"><span className="eyebrow">02</span><i>↗</i></div><h3>VOLUNTEER</h3><p>Build, install and maintain systems with us.</p></a><a href="#contribute" className="contribute-card"><div className="card-header"><span className="eyebrow">03</span><i>↗</i></div><h3>SPREAD THE WORD</h3><p>Share the work with people who can carry it further.</p></a></div><a href="#contribute" className="donate-button" style={{ display: 'inline-block', marginTop: '3.5rem', padding: '1.2rem 3rem', fontSize: '.8rem' }}>DONATE TODAY</a></section>
    <Footer />
  </main>
}

const links: [string, string][] = [['HOME', '#top'], ['VISION', '#vision'], ['MISSION', '#mission'], ['CURRENT', '#current'], ['FUTURE', '#future'], ['HISTORY', '#history'], ['ABOUT', '#foundation'], ['CONTACT', '#contribute']]
